...
(function () {
    ...
    JustinCredible.TheWeek.Boot2.setInitialRoute(window.location.hash);
    ...
    if (window.buildVars.config.isWebPlatform) {
        ...
        var loaderInterval = setInterval(function () {
            ...
            if (window.__css_loaded && window.__lib_loaded && window.__js_loaded) {
                ...
                JustinCredible.TheWeek.Boot2.boot();

                // Now manually bootstrap Angular with the body element.
                angular.bootstrap(document.body, ["JustinCredible.TheWeek.Application"]);
            }
